...
Discourse::Application.routes.draw do
  ...
  %w{users u}.each_with_index do |root_path, index|
    ...
    get "#{root_path}/:username/preferences/phone" => "users_phone#index", constraints: { username: USERNAME_ROUTE_FORMAT }
    ...
    put "#{root_path}/:username/preferences/phone" => "users_phone#update", constraints: { username: USERNAME_ROUTE_FORMAT }
  ...
  post "posts/create_story" => "posts#create_story"
